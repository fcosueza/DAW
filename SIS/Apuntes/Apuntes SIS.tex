...
\begin{itemize}
    \item \textbf{Especificaciones Básicas}: Son los requisitos mínimos para que la aplicación pueda ejecutarse correctamente. Suelen incluir:
    \begin{itemize}
    ...
    \item \textbf{Especificaciones Recomendadas}: Además de los requisitos mínimos, los fabricantes suelen especificar un \textbf{requisitos recomendados}, para conseguir un funcionamiento eficaz de la aplicación y con un rendimiento satisfactorio. Éstos suelen incluir:
