...
La \textbf{toma de decisiones} de el \textbf{proceso} por el cuál se realiza \textbf{una elección} entre \textbf{las alternativas} para resolver diferentes situaciones de la vida. Consiste, básicamente, en elegir una alternativa de entre las disponibles a los efectos de resolver un problema.
...
\begin{itemize}
    ...
    \begin{figure}[ht]
        ...
        \caption{Tabla con alternativas del proceso de toma de decisiones}
    \end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Tabla perfil profesional vs requisitos empresas}
    \label{tab:emp}
\end{figure}
...
Por todo esto, es importante que sepas elaborar correctamente un currículum vitae. Por ello te recomendamos que veas \href{https://www.youtube.com/watch?v=NQG8DLkS29s\&ab\_channel=SEPEServicioP\%C3\%BAblicoEmpleoEstatal}{este vídeo} de SEPE donde se explica como redactar un currículum.
