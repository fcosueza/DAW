...
\newglossaryentry{ERP}{
    name={ERP},
    description={Enterprise Resourcer Planning}
}
...
\newglossaryentry{OBPL}{
    name={OBPL},
    description={Openbravo Public Licence}
}

\newglossaryentry{OBCL}{
    name={OBCL},
    description={Openbravo Commercial Licence}
}
