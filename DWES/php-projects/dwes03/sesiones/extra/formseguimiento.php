...
<form action="registrarseguimiento.php" method="post">
    ...
    <label for="fecha">Fecha:
        <input type="text" id="fecha" name="fecha" value="<?php if (isset($datos) && $datos['fecha_espanol']) echo $datos['fecha_espanol']; ?>"> (formato dd/mm/AAAA)
    </label>
    <br>

    <label for="hora">Hora:
        <input type="text" id="hora" name="hora" value="<?php if (isset($datos) && $datos['hora']) echo $datos['hora']; ?>">(formato HH:mm)
    </label>
    <br>
    ...
    <?php if (isset($empleados)) : ?>
          <label for="idempleado">Empleado:
              <select id="idempleado" name="empleado">
                  <?php foreach ($empleados as $datosEmpleado) : ?>
    ...
    <label for="medio">Medio de Contacto:
    ...
    <label for="otro">Otro medio de contacto:
        <input type="text" name="otro" id="otro" value="<?= htmlspecialchars($datos['otro'] ?? ''); ?>">
    </label>
