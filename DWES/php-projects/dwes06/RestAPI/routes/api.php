...
/*
  ...
  Route::delete("talleres/{idTaller}", [TalleresControllerAPI::class, "destroy"])->whereNumber("idTaller");

  Route::patch("talleres/{idTaller}/cambiarubicacion", [TalleresControllerAPI::class, "cambiarUbicacion"])->whereNumber("idTaller");
