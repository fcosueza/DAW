...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.40]{netbeans-2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.60]{ident-java.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.70]{palabras-reservadas.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.65]{ejemplo-variables.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[scale=0.65]{ejemplo-variables-2.png}
\end{figure}

La salida del programa por pantalla será la siguientes:

\begin{figure}[H]
    \includegraphics[scale=0.50]{salida-ejemplo-variables-2.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[scale=1]{ejemplo-referencia.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[scale=0.70]{ejemplo-enum.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[scale=1]{declaracion-variables-1.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[scale=1]{declaracion-variables-2.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[scale=0.65]{declaracion-variables-4.png}
\end{figure}

El resultado que se obtendrá por pantalla al ejecutar este programa tendrá el siguiente aspecto:

\begin{figure}[H]
    \includegraphics[scale=0.55]{declaracion-variables-4-salida.png}
\end{figure}
...
Un \textbf{literal carácter} puede escribir con un carácter entre comillas simples, como \textbf{`a'}, \textbf{`ñ'},\textbf{`Z'}, etc., o por su código de la tabla Unicode, anteponiendo la secuencia de escape \textbf{`\'} si el valor lo pones en octal, \textbf{`\textbackslash u'} si el valor lo ponemos en hexadecimal. Por ejemplo, si sabemos tanto que tanto en código ASCII como en Unicode, la letra A (mayúscula) es el símbolo número 65, y que 65 en octal es 101 y 41 en hexadecimal, podemos representar esta letra comom \textbf{\textbackslash 101} en octal o \textbf{\textbackslash u0041}. Existen, ademas, unos caracteres especiales que se presentan utilizando secuencias de escape.
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[scale=0.60]{secuencias-escape.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.60]{operadores-aritmeticos.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.60]{operadores-resultado.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.60]{operadores-unarios.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.62]{operadores-ejemplo.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.70]{operadores-asignacion.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.65]{operadores-relacionales.png}
...
\begin{figure}[H]
    \includegraphics[scale=0.48]{uso-scanner.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.70]{operadores-booleanos.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.65]{operadores-condicionales.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.52]{operadores-binarios.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.65]{operaciones-cadenas.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.60]{operaciones-cadenas-salida.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.70]{preferencia-operadores.png}
...
\begin{figure}[H]
    \includegraphics[scale=0.80]{casting.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.60]{anexo-conversiones-1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.65]{conversion-consideraciones.png}
