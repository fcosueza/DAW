...
En la aplicación se van a definir 3 roles que nos van a ayudar a limitar los permisos que van a tener los diferentes usuarios. Estos roles, aunque estarán definidos en la base de datos, van a gestionarse de forma programática desde la aplicación, ya que se puede aplicar de forma más granular el control de acceso. Los roles que se han creado son:
...
Destacar que aunque se ha intentado realizar el diseño de la forma más eficiente, \textbf{puede que haya cambios} en la arquitectura de la base de datos. De ser así, \textbf{se documentará} cada cambio y \textbf{se explicará }el motivo de haberlo  realizado. 
