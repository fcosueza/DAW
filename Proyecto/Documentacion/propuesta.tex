...
\subsection{Contexto}
Esta aplicación es un \textbf{proyecto personal} que se ha decidido desarrollar tras el análisis de diferentes aplicaciones del sector para la gestión vecinal y ver determinadas carencias, tanto en al accesibilidad como en una oferta completa de características que permite gestionar todos los aspectos de una comunidad bajo la misma aplicación.

Hay que tener en cuenta, que los usuarios objetivos son un grupo muy heterogéneo donde podemos encontrar personas con diferente formación, conocimientos sobre tecnologías o con problemas de accesibilidad, así como gente con dificultades económicas. Por este motivo, se ha decidido realizar una \textbf{aplicación gratuita}, centrándonos en la \textbf{accesibilidad} y \textbf{facilidad de uso}, que ayude a cualquier potencial usuario a realizar la gestión de su comunidad de forma sencilla e intuitiva. 
...
\begin{itemize}
	...
	\item \textbf{Gestión de Finanzas}: la aplicación debe realizar, de forma automática, cálculos para administrar económicamente la comunidad, calculando el balance anual a partir de las cuotas que se están pagando y de los diferentes gastos que está teniendo al comunidad.
	
	\item \textbf{Comunicación entre Usuarios}: la aplicación debe permitir el envío de mensajes entre los diferentes usuarios, habilitando la comunicación entre ellos de una forma sencilla.
\end{itemize}
...
\begin{itemize}
	...
	Además, deberá tener un \textbf{menú} donde, además de enlaces a las diferentes secciones, deberá incluir enlaces hacia las páginas de login y registro.
	...
	En está página, el \textbf{menú de la barra superior} solo contendrá 2 enlaces, uno a la página principal y otro a la de registro. La sección de \textbf{pie de página} solo deberá incluir al información de copyright.
	...
	En está página, el \textbf{menú de la barra superior} solo contendrá 2 enlaces, uno a la página principal y otro a la de login. La sección de \textbf{pie de página} solo deberá incluir al información de copyright.
