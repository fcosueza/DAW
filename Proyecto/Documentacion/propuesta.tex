...
\begin{itemize}
	\item \textbf{Comunidad}(\underline{id\_comunidad}, nombre, calle, numero, localidad, provincia, pais)
...
\begin{itemize}
	\item \textbf{inscripción}(\uline{\dashuline{usuario, comunidad}}, fecha)
