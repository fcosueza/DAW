...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.50]{esquema-entidad-relacion.png}
...
\begin{enumerate}
    ...
    \item A continuación, vamos a descargar el archivo con el \textbf{script sql} para la creación de tablas. El archivo podemos encontrarlo \href{https://github.com/fcosueza/DAW/blob/main/BD/Apu ntes/archivos/bases-datos-tema-4-oracle.zip}{este enlace}  de github, y pulsando en \textbf{download} lo descargamos.
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.50]{creacion-oracle-5.png}
