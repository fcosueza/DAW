...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.25]{resultado-consulta-5.png}
...
SELECT MAX(precio) AS ProductoMasCaro, MIN(precio) AS ProductoMasBarato FROM productos;
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.25]{resultado-consulta-6.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.25]{resultado-consulta-7.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.25]{resultado-consulta-8.png}
...
SELECT DNI_cliente, numero_fisio, fecha, precio FROM cita WHERE DNI_cliente = "27256987J";
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.27]{resultado-consulta-9.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.27]{resultado-consulta-10.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.26]{resultado-consulta-11.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.26]{resultado-consulta-12.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.25]{resultado-consulta-13.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.25]{resultado-consulta-14.png}
