...
\begin{enumerate}
    ...
    En nuestro caso, podríamos seleccionar en el menu ``Select Operatig System'' de la página Ubuntu  como sistema operativo y realizar la instalación mediante APT, pero como lo que se nos pide es que usemos el instalador, vamos a seleccionar Linux Generic
\end{enumerate}
% Bibliography
